...
phidgetAmmeter.Start()
phidgetAmmeter.CurrValue()
phidgetAmmeter.Stop()
...
let sensors = [| phidgetAmmeter :> GenericSensor; new RemoteSensor("proc_user_time_perc", DataType.Unknown) :> GenericSensor; new RemoteSensor("cache-_misses_perc", DataType.Unknown) :> GenericSensor; new RemoteSensor("seconds", DataType.Unknown) :> GenericSensor|]
//let sensors = [| extechWatt :> GenericSensor; phidgetAmmeter :> GenericSensor |]
...
let e = new Experiment("quick_win_vostro", sensors, 0, [| "size" |], [||], fun _ -> ())
let e = new Experiment("merges_win_vostro", sensors, 0, [| "size" |], [||], fun _ -> ())
let e = new Experiment("heap_win_vostro", sensors, 0, [| "size" |], [||], fun _ -> ())
...
let e = new Experiment("pi_win", sensors, 0, [| "size" |], [||], fun _ -> ())
